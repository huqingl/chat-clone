...
const PdfAnswerSection = ({ storedValues, canInput, loading }) => {
  //随着内容增加，自动滚动到底部
    ...
    <>
      <div className="answer-container overflow-hidden h-full">
        <div className="answer-wrapper h-full overflow-y-auto">
          <div className="hidden prompt-wrapper border-gray-300 bg-gray-100">
          ...
          <div className="answer-content-box ">
            {storedValues.map((value, index) => {
              ...
              return (
                <div
                  className="answer-section-wrapper w-full"
                  // style={{ borderBottom: "1px solid #eee" }}
                  key={index}
                >
                  <div className="answer-section mobile:w-11/12 w-4/5 mt-0 mx-auto text-base ">
                    <div
                      className={`${
                        value.role === "assistant" ? "justify-end" : ""
                      } answer-content-wrapper flex p-2 `}
                    >
            ...
            >
              <div className="prompt mobile:w-11/12 w-4/5 mt-0 mx-auto flex p-2">
                {/* <div className="pr-5 mobile:pr-2.5">
                  <IconFont
                    type="icon-openai-icon"
                    style={{ fontSize: "24px", color: "green" }}
...
export default PdfAnswerSection;
